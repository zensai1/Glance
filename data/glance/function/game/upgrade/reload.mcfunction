...
##return
    ...
    execute if score @s Znsi.MaxReload matches ..20 run tellraw @s {"color":"red","text":"これ以上は強化できません"}
    execute if score @s Znsi.MaxReload matches ..20 run return 0
