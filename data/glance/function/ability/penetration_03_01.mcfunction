#>glance:ability/penetration_03_01
#
#
#@execution -> glance:system/game | glance:ability/penetration_03_01


##パーティクル
    function glance:ability/penetration_03_02
...
##再帰
    execute if entity @s[scores={Znsi.Range=1..}] at @s run function glance:ability/penetration_03_01
