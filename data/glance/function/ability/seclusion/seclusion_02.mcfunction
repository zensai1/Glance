#>glance:ability/seclusion/seclusion_02
...
##小数が1以上だったら小数を1減少
    ...
    execute if score @s Znsi.Decimal matches 0 if score @s Znsi.Integer matches 0 run function glance:ability/seclusion/seclusion_03