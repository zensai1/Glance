#>glance:ability/penetration_04_01
...
##ダメージ判定
    execute if score @s Znsi.HitCheck matches 0 at @s as @a[tag=Znsi.Target,limit=1,sort=nearest] at @s run function glance:ability/penetration_04_02
