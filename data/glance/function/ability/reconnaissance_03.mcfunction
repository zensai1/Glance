#>glance:ability/reconnaissance_03
...
##小数が1以上だったら小数を1減少
    ...
    execute if score @s Znsi.Decimal matches 0 if score @s Znsi.Integer matches 0 run function glance:ability/reconnaissance_05 with storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Reconnaissance